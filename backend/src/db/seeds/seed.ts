...
const products = [
  ...
  {
    slug: "rudy-airstorm",
    name: "Шлем Rudy Project Airstorm Lime Fluo White Shiny",
    description:
      "Аэродинамический шлем для шоссе и триатлона. Отличная вентиляция при высокой скорости.",
    price: 18900,
    old_price: 21500,
    categorySlug: "helmets",
    brandSlug: "rudy-project",
    country: "Italy",
    countryCode: "it",
    frameSlug: null,
    rating: 4.7,
    rating_count: 22,
    specs: { Год: 2022, Материал: "Поликарбонат", Вес: "250 г", Вентиляция: "16 отверстий" },
  },
  {
    slug: "rudy-avenger",
    name: "Шлем Rudy Project Avenger Titanium Lime Matt",
    description:
      "Универсальный шлем для шоссе и кросс-кантри с регулировкой затылочной части.",
    price: 15400,
    old_price: null,
    categorySlug: "helmets",
    brandSlug: "rudy-project",
    ...
    rating: 4.5,
    rating_count: 31,
    specs: { Год: 2022, Материал: "Поликарбонат", Вес: "270 г", Вентиляция: "22 отверстия" },
  },
  {
    slug: "rudy-protera",
    name: "Шлем Rudy Project Protera Blue Orange Matt",
    description:
      "Шлем для трейла и эндуро с увеличенной защитой затылка и съёмным козырьком.",
    price: 16700,
    old_price: 19900,
    categorySlug: "helmets",
    brandSlug: "rudy-project",
    ...
    rating: 4.6,
    rating_count: 14,
    specs: { Год: 2022, Материал: "Поликарбонат", Вес: "310 г", Козырёк: "Съёмный" },
  },
];
  ...
  for (const product of products) {
    await client.query(
      `INSERT INTO products (
         ...
         category_id, brand_id, country, country_code, frame_material_id,
       ...
       VALUES (
         ...
         $8,
         $9,
         (SELECT id FROM frame_materials WHERE slug = $10),
         $11, $12, $13
       )`,
      [
        product.slug,
...
const variants = [
  ...
  // шлемы Rudy Project
  { productSlug: "rudy-airstorm", size: "M", colorSlug: "white", stock: 4 },
  { productSlug: "rudy-airstorm", size: "L", colorSlug: "white", stock: 2 },
  { productSlug: "rudy-avenger", size: "M", colorSlug: "grey", stock: 5 },
  { productSlug: "rudy-avenger", size: "L", colorSlug: "grey", stock: 0 },
  { productSlug: "rudy-protera", size: "M", colorSlug: "blue", stock: 3 },
  { productSlug: "rudy-protera", size: "L", colorSlug: "blue", stock: 1 },
];
...
const images = [
  ...
  { productSlug: "scott-arx-plus-helmet", alt: "Шлем Scott ARX Plus, вид сбоку" },
  { productSlug: "rudy-airstorm", alt: "Шлем Rudy Project Airstorm, вид сбоку" },
  { productSlug: "rudy-avenger", alt: "Шлем Rudy Project Avenger, вид сбоку" },
  { productSlug: "rudy-protera", alt: "Шлем Rudy Project Protera, вид сбоку" },
];
