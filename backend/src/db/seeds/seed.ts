...
const products = [
  ...
  {
    slug: "scott-arx-plus-helmet",
    name: "Шлем Scott ARX Plus 2022",
    description:
      "Лёгкий вентилируемый шлем для шоссе и кросс-кантри. Система регулировки MIPS.",
    price: 12900,
    old_price: 15900,
    ...
    rating: 4.6,
    rating_count: 34,
    specs: { Год: 2022, Материал: "Поликарбонат", Вес: "280 г" },
  },
  {
    slug: "trek-circuit-gloves",
    name: "Перчатки Trek Circuit Full Finger 2022",
    description: "Длиннопалые велоперчатки с гелевыми вставками.",
    price: 3400,
    old_price: null,
    categorySlug: "gloves",
    brandSlug: "trek",
    ...
    rating: 4.2,
    rating_count: 51,
    specs: { Год: 2022, Материал: "Синтетика", Тип: "Длиннопалые" },
  },
  {
    slug: "orbea-advanced-jacket",
    name: "Велокуртка Orbea Advanced Wind 2021",
    description: "Ветрозащитная куртка для межсезонья, компактно складывается.",
    price: 8700,
    old_price: null,
    ...
    rating: 4.4,
    rating_count: 19,
    specs: { Год: 2021, Материал: "Полиэстер", Защита: "Ветрозащита" },
  },
  {
    slug: "topeak-frame-bag",
    name: "Сумка на раму Topeak MidLoader 4.5L",
    description: "Подрамная сумка для бэкпакинга, крепление на липучках.",
    price: 5600,
    old_price: 6900,
    categorySlug: "bags",
    brandSlug: "trek",
    ...
    rating: 4.7,
    rating_count: 27,
    specs: { Объём: "4.5 л", Крепление: "Липучки", Водозащита: "Да" },
  },
  {
    slug: "bianchi-front-light",
    name: "Фонарь передний Bianchi Vision 800",
    description: "Передний фонарь 800 люмен с аккумулятором и USB-зарядкой.",
    price: 4200,
    old_price: null,
    categorySlug: "lights",
    brandSlug: "bianchi",
    ...
    rating: 4.3,
    rating_count: 42,
    specs: { Яркость: "800 лм", Питание: "Аккумулятор", Зарядка: "USB-C" },
  },
  {
    slug: "scott-syncros-wheelset",
    name: "Колёса Scott Syncros Silverton 2.0 29",
    description: "Комплект колёс 29 дюймов для кросс-кантри, алюминиевые обода.",
    price: 38900,
    old_price: null,
    categorySlug: "wheels",
    brandSlug: "scott",
    ...
    rating: 4.5,
    rating_count: 8,
    specs: { Диаметр: "29", Материал: "Алюминий", Тип: "Бескамерные" },
  },
  {
    slug: "shimano-hg601-chain",
    name: "Цепь Shimano CN-HG601 11 скоростей",
    description: "Цепь для 11-скоростных трансмиссий, покрытие SIL-TEC.",
    price: 2800,
    old_price: null,
    categorySlug: "chains",
    brandSlug: "trek",
    ...
    rating: 4.8,
    rating_count: 63,
    specs: { Скоростей: 11, Звеньев: 116, Покрытие: "SIL-TEC" },
  },
  {
    slug: "tacx-flow-trainer",
    name: "Велостанок Tacx Flow Smart T2240",
    description:
      "Умный велостанок с электромагнитной нагрузкой, поддержка Zwift.",
    price: 47500,
    old_price: 52000,
    ...
    rating: 4.4,
    rating_count: 15,
    specs: { Тип: "Роликовый", Мощность: "800 Вт", Связь: "ANT+, Bluetooth" },
  },
];
...
const variants = [
  ...
  // шлем целиком распродан — на нём проверяется фильтр «только в наличии»
  { productSlug: "scott-arx-plus-helmet", size: "M", colorSlug: "black", stock: 0 },
  { productSlug: "scott-arx-plus-helmet", size: "L", colorSlug: "white", stock: 0 },

  { productSlug: "trek-circuit-gloves", size: "M", colorSlug: "black", stock: 12 },
  { productSlug: "trek-circuit-gloves", size: "L", colorSlug: "black", stock: 4 },
  { productSlug: "orbea-advanced-jacket", size: "M", colorSlug: "orange", stock: 3 },
  { productSlug: "orbea-advanced-jacket", size: "L", colorSlug: "black", stock: 0 },
  { productSlug: "topeak-frame-bag", size: null, colorSlug: "black", stock: 9 },
  { productSlug: "bianchi-front-light", size: null, colorSlug: "celeste", stock: 6 },
  { productSlug: "scott-syncros-wheelset", size: null, colorSlug: "grey", stock: 2 },
  { productSlug: "shimano-hg601-chain", size: null, colorSlug: "silver", stock: 25 },
  { productSlug: "tacx-flow-trainer", size: null, colorSlug: "black", stock: 1 },
];
